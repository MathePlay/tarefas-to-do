...
export default function Header() {
    return (
        <header className="flex px-7 py-1.5 h-12 w-full bg-[#ce7a27] border-b border-[#484644] justify-between">
            <div className="flex flex-col items-center">
                <h1 className="font-semibold text-lg leading-none ">Ambiente de teste</h1>
